[![Nix Omnix CI](https://github.com/nikmctrl/nix-gh-ci/actions/workflows/ci-nix.yml/badge.svg?branch=ci-optimisation&event=push)](https://github.com/nikmctrl/nix-gh-ci/actions/workflows/ci-nix.yml)
